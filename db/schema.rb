...
ActiveRecord::Schema[7.0].define(version: 2023_11_09_093007) do
  ...
  create_table "addresses", charset: "utf8mb4", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["barangay_id_id"], name: "index_addresses_on_barangay_id_id"
    t.index ["city_id_id"], name: "index_addresses_on_city_id_id"
    t.index ["province_id_id"], name: "index_addresses_on_province_id_id"
    t.index ["region_id_id"], name: "index_addresses_on_region_id_id"
